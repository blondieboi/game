...
var brainrotShopItems = [
  { id: "skibidi", name: "Skibidi Toilet", emoji: "🚽", description: "En legend som lever vidare i evighet", emeraldCost: 3, diamondCost: 1 },
  { id: "sigma", name: "Sigma", emoji: "💪", description: "Du är din egen boss. Grindset.", emeraldCost: 2, diamondCost: 2 },
  { id: "rizzler", name: "Rizzler", emoji: "💎", description: "Karisman är obegränsad", emeraldCost: 5, diamondCost: 0 },
  { id: "ohio", name: "Ohio", emoji: "🌽", description: "Bara i Ohio...", emeraldCost: 0, diamondCost: 2 },
  { id: "fanum", name: "Fanum Tax", emoji: "💰", description: "Skatt som måste betalas. Fanum style.", emeraldCost: 4, diamondCost: 1 },
  { id: "gyatt", name: "Gyatt", emoji: "🦷", description: "När något är så imponerande... gyatt!", emeraldCost: 2, diamondCost: 3 },
  { id: "npc", name: "NPC", emoji: "🤖", description: "Du följer strömmen. Som alla andra.", emeraldCost: 3, diamondCost: 0 },
  { id: "hawk-tuah", name: "Hawk Tuah", emoji: "🌮", description: "Legendary. Iconic. Hawk Tuah.", emeraldCost: 3, diamondCost: 3 },
  { id: "67", name: "67", emoji: "6️⃣7️⃣", description: "Du vet vad det är. 67. Always.", emeraldCost: 5, diamondCost: 1 },
  { id: "tralalero", name: "Tralalero Tralala", emoji: "🎶", description: "S-tier maskot. Bizar. Ikonisk. Tralalero tralala.", emeraldCost: 3, diamondCost: 4 },
  { id: "tung-tung", name: "Tung Tung Tung", emoji: "🔨", description: "Tung tung tung sahur. Det fastnar i huvudet.", emeraldCost: 4, diamondCost: 1 },
  { id: "cappuccino", name: "Cappuccino Assassino", emoji: "☕", description: "En mördare med cappuccinohuvud. Dödlig.", emeraldCost: 2, diamondCost: 4 },
  { id: "bombardiro", name: "Bombardiro Crocodilo", emoji: "🐊", description: "Tungt bepansrad krokodil. Explosiv.", emeraldCost: 6, diamondCost: 1 },
  { id: "boneca", name: "Boneca Ambalabu", emoji: "🪆", description: "Surrealistisk. Chanten som alla sjunger.", emeraldCost: 1, diamondCost: 2 },
  { id: "lirili", name: "Lirilí Larilà", emoji: "🐘", description: "En elefant med kaktuskropp. Varför? Varför inte.", emeraldCost: 4, diamondCost: 0 },
  { id: "chimpanzini", name: "Chimpanzini Bananini", emoji: "🐵", description: "En galen bananchimpans. Monke.", emeraldCost: 2, diamondCost: 3 },
  { id: "ballerina", name: "Ballerina Cappucina", emoji: "🩰", description: "Cappuccinoballerinan. Dansar sig igenom din hjärna.", emeraldCost: 4, diamondCost: 1 },
  { id: "vaca-saturno", name: "La Vaca Saturno Saturnita", emoji: "🪐", description: "En kosmisk ko från Saturnus. Trippy.", emeraldCost: 4, diamondCost: 5 },
];
